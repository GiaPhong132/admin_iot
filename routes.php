...
$controllers = array(
    ...
    'products' => ['index', 'add', 'editInfo', 'delete', 'sort', 'getUserChart', 'getFanChart', 'getGasChart', 'getHumiChart', 'getTempChart', 'getLedChart', 'getPirChart', 'getServoChart'],
...
require_once('/xampp/htdocs/admin_iot/controllers/' . $page . "/" . $controller . '_controller.php');
